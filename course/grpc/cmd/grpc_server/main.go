...
func (s *server) Create(ctx context.Context, req *desc.CreateRequest) (*desc.CreateResponse, error) {
	...
	builderInsert := squirrel.Insert("note").
		...
		Values(id, req.GetInfo().GetName(), req.GetInfo().GetPrice(), req.GetInfo().GetDescription(), req.GetInfo().GetComposition(), req.GetInfo().GetAuthor(), req.GetInfo().GetPhotoUrl(), time.Now().Format("2006-01-02 15:04:05.999999"), time.Now().Format("2006-01-02 15:04:05.999999"))
